...
namespace ShopSnowboardEquip.Controllers
{
...

    {
        ...
        public EquipmentController(AppDbContext context, ICategoryRepository categoryRepository, IEquipmentRepository equipmentRepository)
		{
        ...
        {
            var appDbContext = _context.Equipments.Include(e => e.Category);
        ...
        public async Task<IActionResult> Create([Bind("EquipmentId,Name,ShortDescription,LongDescription,Price,ImageUrl,ImageThumbnailUrl,IsPreferredEquipment,InStock,CategoryId")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int EquipmentId, [Bind("EquipmentId,Name,ShortDescription,LongDescription,Price,ImageUrl,ImageThumbnailUrl,IsPreferredEquipment,InStock,CategoryId")] Equipment equipment)
        {
