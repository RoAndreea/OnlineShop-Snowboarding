			...
			get
			{
				return new List<Equipment>
				{
					new Equipment {
						...
						ImageThumbnailUrl ="/images/snow.png"
					},
					new Equipment{
						Name = "SkiEquipment",
						...
						ImageThumbnailUrl = "/images/ski.png"
					},
					new Equipment {
						Name = "SkiHelmet",
						...
						InStock = true,
						IsPreferredEquipment = false,
						ImageThumbnailUrl = "/images/casca.png"
                    },
					new Equipment
					{
						Name = "SkiCostume",
						...
						InStock = true,
						IsPreferredEquipment = false,
						ImageThumbnailUrl = "/images/costum.png"
                    }
				};
			}
		}

		public IEnumerable<Equipment> PreferredEquipments { get; }
